  ...
  return (
    <PageWrapper>
      {home ? (
        ...
        <div style={{ background: '#f0f2f7', minHeight: '100%' }}>
          ...
          <div style={{ padding: '20px 18px 32px', display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: '0.5px solid #d1d5db', fontSize: 14, fontWeight: 600,
                    cursor: 'pointer',
                  }}
                >
                  Log In
            ...
            <div
              onClick={() => open('signup')}
              style={{
                background: '#0d1f3c', borderRadius: 18,
            ...
            >
              ...
              <img
                src={earnBanner}
                alt=""
                style={{ height: 80, opacity: 0.9, flexShrink: 0 }}
              />
            </div>
              ...
              {features.map(({ icon: Icon, title, desc }, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderBottom: i < features.length - 1 ? '0.5px solid #f1f5f9' : 'none',
                  }}
                >
                  <div style={{
        ...
        /* ── Auth / splash variant ── */
        <div style={{
          background: '#f0f2f7', minHeight: '100%',
          ...
          <div style={{ width: '100%', maxWidth: 320, display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <button
              ...
              style={{
                ...
                border: '0.5px solid #d1d5db', fontSize: 14, fontWeight: 600, cursor: 'pointer',
              }}
            >
              Log In
            </button>
      ...
      <Signup open={openDrawer.signup} setOpenDrawer={() => close('signup')} />
      <SignIn open={openDrawer.signin} setOpenDrawer={() => close('signin')} />
    </PageWrapper>
  );
};
