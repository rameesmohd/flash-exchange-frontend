            ...
            <Row gutter={[8, 4]}>
              ...
              {/* {
                ...
                <div className='w-full rounded-md '>
                  {
                    value.receipts.map((value)=><div className='flex justify-between items-center border pl-1 pr-2 py-1 mb-1 rounded-md shadow-sm'> 
                    <Image
                      width={50}
                      height={50}
                      src={value}
                    ...
                    /> <br />
                    <a href={value} download target="_blank" rel="noopener noreferrer"><DownloadIcon className='w-4 h-4' /></a>
                    </div>
                  )}
                </div>
              </>
                ...
                <div className='flex rounded-md flex-wrap'>
                  {
                    ...
                    <Image
                      ...
                      fallback="data:image/png;base64,"
                    /> <br />
                    <a href={value} download target="_blank" rel="noopener noreferrer"><DownloadIcon className='w-4 h-4 mx-auto' /></a>
                    </div>
                  )}
                </div>
              </>
